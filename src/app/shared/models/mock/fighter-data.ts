...
export default class FighterData {
  ...
  static loadSkillLines(skillTree: SkillTree) {
    ...
    skillTree.hlrSkillIds["10-3"] = true;
    skillTree.vltSkillIds["10-3"] = true;
    skillTree.vltSkillIds["10-4"] = true;
    skillTree.hllSkillIds["10-4"] = true;
