...
export default class BouncerData {
  static loadSkillLines(skillTree: SkillTree) {
    ...
    skillTree.hlfSkillIds["5-3"] = true;
    skillTree.vltSkillIds["5-3"] = true;
    skillTree.hllSkillIds["5-4"] = true;
    ...
    skillTree.hllSkillIds["9-4"] = true;
    ...
    skillTree.vlfSkillIds["11-1"] = true;
    ...
    skillTree.vltSkillIds["12-4"] = true;
    skillTree.vlfSkillIds["13-0"] = true;
    skillTree.hlrSkillIds["13-0"] = true;
    skillTree.hlfSkillIds["13-1"] = true;
    skillTree.hllSkillIds["13-2"] = true;
    ...
    skillTree.vltSkillIds["15-3"] = true;
  }
