...
export default class HunterData {
  static getSkillTree(): SkillTree {
    ...
    skillTree.vlfSkillIds["3-1"] = true;
    skillTree.vlbSkillIds["2-2"] = true;
    skillTree.vlfSkillIds["3-2"] = true;
    skillTree.vlfSkillIds["3-4"] = true;
    skillTree.vlbSkillIds["2-4"] = true;
    skillTree.vlfSkillIds["4-4"] = true;
    ...
    skillTree.hllSkillIds["6-3"] = true;
    ...
    skillTree.hlfSkillIds["7-4"] = true;
    skillTree.hllSkillIds["7-5"] = true;
    skillTree.vlfSkillIds["7-2"] = true;
    skillTree.vlfSkillIds["7-4"] = true;
    skillTree.vlfSkillIds["7-5"] = true;
    skillTree.hlrSkillIds["8-2"] = true;
    skillTree.hllSkillIds["8-3"] = true;
    skillTree.vlfSkillIds["8-2"] = true;
    skillTree.vltSkillIds["8-3"] = true;
    skillTree.vltSkillIds["8-4"] = true;
    skillTree.vltSkillIds["8-5"] = true;
    skillTree.hlrSkillIds["9-2"] = true;
    skillTree.hlfSkillIds["9-3"] = true;
    skillTree.vlfSkillIds["9-2"] = true;
    skillTree.vltSkillIds["9-3"] = true;
    skillTree.vltSkillIds["9-4"] = true;
    skillTree.hlfSkillIds["9-4"] = true;
    skillTree.vlfSkillIds["9-5"] = true;
    skillTree.hllSkillIds["9-5"] = true;
    skillTree.hlrSkillIds["10-2"] = true;
    skillTree.vlfSkillIds["10-2"] = true;
    ...
    skillTree.hlrSkillIds["11-2"] = true;
    skillTree.vltSkillIds["11-2"] = true;
    skillTree.hlfSkillIds["11-3"] = true;
    skillTree.vltSkillIds["11-3"] = true;
    skillTree.hllSkillIds["11-4"] = true;
