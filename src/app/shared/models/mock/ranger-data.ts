...
export default class RangerData {
  static loadSkillLines(skillTree: SkillTree) {
    ...
    skillTree.vlbSkillIds["4-5"] = true;
    skillTree.vlfSkillIds["5-0"] = true;
    skillTree.hllSkillIds["5-5"] = true;
    skillTree.hlrSkillIds["5-4"] = true;
    ...
    skillTree.vlfSkillIds["6-5"] = true;
    ...
    skillTree.hlfSkillIds["10-3"] = true;
    skillTree.vlfSkillIds["10-3"] = true;
    skillTree.vltSkillIds["10-4"] = true;
    skillTree.hlfSkillIds["10-4"] = true;
